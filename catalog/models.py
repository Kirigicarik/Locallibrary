...
class Book(models.Model):
    ...
    # Foreign key used because a book can have only one author,but authors can have multiple books
    # Author as a string than an object because it hasn't been declared yet in the file
    ...
    # Manytomany fields used because genre can contain many books. Books can cover many genres.
